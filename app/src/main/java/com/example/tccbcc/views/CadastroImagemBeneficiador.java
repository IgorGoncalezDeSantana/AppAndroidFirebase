...
public class CadastroImagemBeneficiador extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastro_imagem_beneficiador);

        imgViewFoto = findViewById(R.id.imgviewFoto);
        btnSelecionarFoto = findViewById(R.id.btnSelecionarFoto2);
                        ...
                        FirebaseFirestore.getInstance().collection("users")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Intent intent = new Intent(CadastroImagemBeneficiador.this, MensagensActivity.class);
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        AlertDialog.Builder builder = new AlertDialog.Builder(CadastroImagemBeneficiador.this);
